...
class Element
{
    ...
    /**
     * Get method name to call on object when retrieving data to render.
     * @return string
     */
    ...
    /**
     * Set method name to call on object when retrieving data to render.
     * @param string $method
     * @return Element
     */
    ...
    /**
     * Get callable to be called when retrieving data to render.
    ...
    /**
     * Set callable to be called when retrieving data to render.
     * @param callable|null $callable
     * @return Element
     */
    public function setCallable($callable): Element
    {
        $this->callable = $callable;
